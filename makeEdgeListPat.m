function pat_Connection = makeEdgeListPat(iEEGhup,data_HUP,cord_HUP,SamplingFrequency)
...
for s = 1:numel(sub.HUP)
    ...
    for elec = 1:size(data,2)
        ...
        pat_Connection = [pat_Connection; [connect, roi2toroi1]];
...
pat_Connection = array2table(pat_Connection);
pat_Connection.Properties.VariableNames = {'roi2','roi1','patientNum',...
